...
export function MetaSection(props: { entry: Anime_Entry, details: AL_AnimeDetailsById_Media | undefined }) {
    // Added container for sticky header clarity
    ...
    const ActionButtons = () => (
        <div data-anime-meta-section-action-buttons className={cn(
    ...
    const Details = () => (
        <div data-anime-meta-section-details className={cn(
            ...
            <div data-anime-meta-section-rankings-container className={cn(
    ...
    return (
        <div className="meta-section-container px-4 py-2">
            <MediaPageHeader
